...
//val primaryLight = Color(0xFFFFB84D)
//val onPrimaryLight = Color(0xFF1D3557)
val primaryContainerLight = Color(0xFFD7E2FF)
val onPrimaryContainerLight = Color(0xFF284677)

val secondaryLight = Color(0xFF535353)    // Grey for secondary elements
...
val surfaceLight = Color(0xFF1D3557)
val onSurfaceLight = Color(0xFFFFFFFF)
val surfaceVariantLight = Color(0xFF44474E)
val onSurfaceVariantLight = Color(0xFF74777F)
val backgroundLight = Color(0xFFF9F9FF)
val onBackgroundLight = Color(0xFF1A1C20)

val errorLight = Color(0xFFCF6679)        // Red for error messages
...
val backgroundDark = Color(0xFF121212)   // Dark background (blackish)
val onBackgroundDark = Color(0xFFFFFFFF)  // White text on dark background
val surfaceDark = Color(0xFF1C1C1C)       // Dark surface for cards, etc.
